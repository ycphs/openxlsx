...
test_that("TRUE, FALSE, NA DF", {
  ...
  y <- read.xlsx(fileName, sheet = 1, asdatatable = FALSE)
  ...
  ## From Workbook
  y <- read.xlsx(wb, sheet = 1, asdatatable = FALSE)
  expect_equal(x, y)
...
test_that("TRUE, FALSE, NA DT", {
  ...
  y <- read.xlsx(fileName, sheet = 1, asdatatable = TRUE)
  ...
  ## From Workbook
  y <- read.xlsx(wb, sheet = 1, asdatatable = TRUE)
  expect_equal(x, y)
